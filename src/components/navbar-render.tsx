...
import { CARTROUTE, STATUSROUTE, CREATEROUTE, TABLEROUTE, HOME, PASSWORDROUTE } from "../lib/routes";
...
const account = localStorage.getItem('accountType');
  switch (account) {
    ...
    case 'staff':
      return (
        <>
          <Link to = {TABLEROUTE} className="navText"> Bill Management </Link> {/*change to appropriate page later*/}
