...
import { CREATEROUTE, MENUROUTE, HOME, CARTROUTE, STATUSROUTE, TABLEROUTE, PASSWORDROUTE, EDITROUTE } from './lib/routes';
    ...
    <div className="App"> 
      ...
      <Router>
        <Routes>
          ...
          <Route path = {STATUSROUTE} element={wrapNavbar(<Status/>)}/>
