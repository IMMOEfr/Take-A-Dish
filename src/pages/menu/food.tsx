...
export const Food = ({food, category, handleDrag}: FoodProps) => {
    ...
    const [Available, setIsAvailable] = useState<boolean>(true);
    ...
    if(account === 'staff') { // Staff Interface
                ...
                <div className="box-container">
                    <div className="item-container">
                        ...
                        <div>
                            {Available? (
                                <>
                                    <button className='availbtn'onClick = {() => handleUpdate(food.id)}>{stockState}</button>
                                </>
                            )
                            :
                            (
                               <>
                                    <button className='outbtn'onClick = {() => handleUpdate(food.id)}>{stockState}</button>
                               </> 
                            )
                        }
        ...
        if(category === 'all' && food.isAvailable === true) {
            return (
                <div style={{display:'inline-block', touchAction: 'none',}}id= {`${food.id}/${quantity}`} draggable="true" onDragStart={handleDrag}>
                    <div className="box-container">
                        <div className="item-container">
                            <img className="menu-img" src = {food.imageURL} onError={(e) => console.log(e)}/>
                            <div className="content">
